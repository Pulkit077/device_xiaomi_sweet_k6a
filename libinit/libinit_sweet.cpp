...
static const variant_info_t sweet_global_info = {
    ...
    .model = "2209116AG",
    .build_fingerprint = "Redmi/sweet_global2/sweet:11/RKQ1.210614.002/V816.0.2.0.THGMIXM:user/release-keys",
    .build_description = "sweet_global2-user 13 TKQ1.221114.001 V816.0.2.0.THGMIXM release-keys",
